...
var (
	ERR_SUCCEED      = CreateErrCode(1000, NewCodeLang("成功", enums.LANG_CN), NewCodeLang("succeed", enums.LANG_EN))
	ERR_STANDARD_ERR = CreateErrCode(1001, NewCodeLang("失败", enums.LANG_CN), NewCodeLang("failed", enums.LANG_EN))
	ERR_SIGN         = CreateErrCode(1002, NewCodeLang("验证未通过", enums.LANG_CN), NewCodeLang("Verification failed", enums.LANG_EN))
	ERR_PARAM        = CreateErrCode(1003, NewCodeLang("参数错误", enums.LANG_CN), NewCodeLang("The parameter is incorrect", enums.LANG_EN))
	ERR_CONFIG_NIL   = CreateErrCode(1004, NewCodeLang("配置为空", enums.LANG_CN), NewCodeLang("The Config Is Nil", enums.LANG_EN))
